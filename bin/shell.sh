...
bin/spark-submit   --class "KafkaTest"   --master spark://10.190.172.43:7077   /mnt/ssd/dm/kafka/spark-application-template/target/scala-2.10/benchmark-breeze-on-spark-assembly-0.0.1.jar 10.190.172.43:9092 test2 3 5 hdfs://10.190.172.89:8020/yanjiedata/kafkaOutput/kafkaOutput1
